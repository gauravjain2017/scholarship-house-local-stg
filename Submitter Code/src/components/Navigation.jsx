        ...
        <div className="flex items-center justify-between h-20">
          ...
          {isAuthenticated ? (
            ...
            <div className="flex items-center">
              <Link
                to="/auth/login"
                className="inline-flex items-center px-5 py-2.5 rounded-lg bg-[#1E7AC0] hover:bg-[#1667A8] text-white text-sm font-semibold shadow-sm transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#0AAFE5]"
              >
                Get Started
              </Link>
            </div>
