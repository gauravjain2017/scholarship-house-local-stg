...
const ForgotPassword = () => {
 ...
 const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Pass userType so backend checks only submitter accounts
      const response = await requestPasswordReset(email, 'submitter');
      if (response?.success === false) {
        setError('No submitter account found with this email address.');
        return;
      }
