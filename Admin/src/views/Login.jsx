...
const Login = () => {
  ...
  // This login page is the admin portal — hardcode the type.
  // Backend will only accept users whose role is "admin" or "team_member"
  // when this login type is sent.
  ...
  const handleSubmit = async (e) => {
    ...
    if (result.success) {
      ...
      if (
        ...
        errorMsg.includes('not a admin') ||
        errorMsg.includes('admin email') ||
