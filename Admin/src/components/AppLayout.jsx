      ...
      <div className="flex flex-col flex-1 overflow-hidden">
        ...
        <header className="flex items-center justify-between px-4 md:px-6 h-14 bg-white border-b border-gray-200 shrink-0">
          ...
          <div className="flex items-center gap-3">
            ...
            {useHasPermission('submit_property.can_create_property') && (<button onClick={() => navigate('/submit')} className="flex items-center gap-1.5 px-4 py-1.5 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition-colors submit_btn">
              + Submit Property
            </button>)}
          </div>
        </header>
