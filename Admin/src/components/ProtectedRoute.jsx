...
import { useHasPermission, hasPermission } from '../utils/roles';
...
const ProtectedRoute = ({
  ...
  const { isAuthenticated, loading, can, user, roles: allRoles } = useAuth();
  ...
  if (requirePermission) {
    ...
    const hasPerm = perms.some((p) => hasPermission(user, allRoles, p));
    if (!hasPerm) return <NoPermission />;
  }
