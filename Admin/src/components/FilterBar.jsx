...
export default function FilterBar({
  ...
  const renderFilterSections = () => (
    <>
      ...
      <AccordionSection title="50-50 Partnership Pro Forma" icon={<span role="img" aria-label="handshake">&#x1F91D;</span>} open={openSection === 'fiftyFifty'} onToggle={() => toggleSection('fiftyFifty')}>
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 px-5 py-6 mb-4 relative">
       <div className="flex items-center gap-3 relative z-50 flex-wrap">
