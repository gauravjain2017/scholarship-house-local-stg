...
const ForgotPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Pass userType so backend checks only admin/team_member accounts
      const response = await requestPasswordReset(email, 'admin');
      if (response?.success === false) {
        setError('No Admin/Team account found with this email address.');
        return;
      }
