        ...
        <div className="bg-surface border border-border-subtle rounded-xl shadow-sm">
          <div className="flex items-center justify-between px-6 py-4">
            <div className="flex flex-col gap-2">
              <button onClick={() => navigate(location.state?.from === 'dashboard' ? '/' : '/admin/users')} className="flex items-center gap-1 text-sm text-text-secondary hover:text-text-primary transition-colors w-fit">
              ...
              <div className="flex gap-2">
                <Button
                  ...
                  onClick={async () => {
                    ...
                    try {
                     await passwordResetAPI.requestPasswordReset(editingUser.email, editingUser.role);
                ...
                <Button
                  ...
                  onClick={async () => {
                    ...
                    try {
                      await passwordResetAPI.adminSetTemporaryPassword(editingUser.email, editingUser.role);
