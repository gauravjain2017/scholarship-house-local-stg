/**
 * Create manage_filters DynamoDB table
 * Run with: node create-manage-filters-table.js
 *
 * Columns: id, label, slug, min_value, max_value, section, enabled, format, step, created_at, updated_at
 */
...
const TABLE_NAME = 'manage_filters';

async function createTable() {
  console.log('\n=== Creating manage_filters DynamoDB Table ===\n');
...
async function main() {
  ...
  try {
    ...
    console.log('\n=== Setup Complete ===\n');
    console.log('The manage_filters table is ready to use!\n');
  } catch (error) {
