...
const { fetchPublicRoles,fetchTeamMembers } = require('../controllers/adminController');
...
router.get('/public-roles', fetchPublicRoles);
router.get('/team-members', fetchTeamMembers);
