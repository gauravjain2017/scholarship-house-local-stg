  ...
  return (
    <div className="bg-app min-h-screen">
      <div className="md:p-10 p-7 max-w-7xl mx-auto">
        ...
        {/* ---------- Role explanation ---------- */}
        <div className="bg-surface border border-border-subtle rounded-3xl md:p-10 md:mb-10 shadow-sm p-6 mb-6">
          <h2 className="text-xl font-semibold text-primary mb-6">Explore investment opportunities</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-panel border border-border-subtle rounded-2xl p-6">
              <h3 className="text-base font-semibold text-primary mb-2">Browse published deals</h3>
              <p className="text-sm text-text-secondary leading-relaxed">
                View approved short-term rental listings with detailed metrics.
              </p>
            </div>
            <div className="bg-panel border border-border-subtle rounded-2xl p-6">
              <h3 className="text-base font-semibold text-primary mb-2">Save listings for later</h3>
              <p className="text-sm text-text-secondary leading-relaxed">
