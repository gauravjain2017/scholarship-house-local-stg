...
export const AuthProvider = ({ children }) => {
  ...
  // login. In this client interface it defaults to 'client', so only users
  // with role "client" will be accepted by the backend.
  const submitterLogin = async (email, password, type = 'client') => {
    try {
